...
[@bs.return null_to_opt] [@bs.send] external getElementById: (Dom.document, string) => option(Dom.element) = "";

[@bs.send] external addEventListener: (Dom.document, string, Dom.event_like('a) => bool, bool) => unit = "";

[@bs.send]
external addEventListenerImg: (imageElement, string, Dom.event_like('a) => bool, bool) => unit = "addEventListener";
